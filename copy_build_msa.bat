...
if not exist %TESTDRIVE%\%CURRENTDATE%_%CURRENTTIME% mkdir %TESTDRIVE%\%CURRENTDATE%_%CURRENTTIME%_release_db
xcopy  /Y /s /e "%PCPATH%\dist\*"  "%TESTDRIVE%\%CURRENTDATE%_%CURRENTTIME%_release_db\" 
